...
class __Mustache_769dc3c16473e212c897544710314b09 extends Mustache_Template
{
...
';
            ...
            $buffer .= $this->section3614d91e4cabdee7a19588ea86ba8d31($context, $indent, $value);
            $buffer .= $indent . '</div>
';
        }
...
';
    ...
    private function section3614d91e4cabdee7a19588ea86ba8d31(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
    ...
    ';
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . '        <div class="groupmode-icon-info">';
