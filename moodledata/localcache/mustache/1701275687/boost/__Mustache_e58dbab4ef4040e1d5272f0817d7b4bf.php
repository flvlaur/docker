...
class __Mustache_e58dbab4ef4040e1d5272f0817d7b4bf extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-template')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block62911360b1c5ce8abcd8dc35e0fa23a3'),
            ));
...
';
    ...
    public function block62911360b1c5ce8abcd8dc35e0fa23a3($context)
    {
        $indent = $buffer = '';
